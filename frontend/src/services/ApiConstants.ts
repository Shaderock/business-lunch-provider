export class ApiConstants {
  ...
  static readonly ORGANIZATION: string = ApiConstants.BACKEND_URL + "/organization";
  ...
  static readonly SUPPLIER_ADM_ORGANIZATION: string = ApiConstants.SUPPLIER_ADM + "/organization";
