...
@Component
public class PercentageFirstDiscountCalculator implements CompanyDiscountTypeCalculator {
  ...
  public boolean supports(CompanyDiscountType companyDiscountType) {
    return companyDiscountType == CompanyDiscountType.PERCENTAGE_FIRST;
  }
  ...
  public double calculate(@NonNull EmployeeOrder employeeOrder,
    ...
    return Math.min(supplierDefaultPrice * discountPercentage / 100,
        supplierDefaultPrice - supplierDiscount);
  }
}
